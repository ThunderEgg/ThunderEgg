...
{
  // corner hasNbr
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::bsw()));
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::bse()));
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::bnw()));
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::bne()));
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::tsw()));
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::tse()));
  CHECK_UNARY_FALSE(domain["bsw_bsw"]->hasNbr(Corner<3>::tnw()));
  CHECK_UNARY(domain["bsw_bsw"]->hasNbr(Corner<3>::tne()));
