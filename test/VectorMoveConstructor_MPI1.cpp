...
TEST_CASE("Vector<2> move from domain constructor")
{
...
TEST_CASE("Vector<2> move from managed constructor")
{
  for (int num_components : { 1, 2, 3 }) {
    for (auto num_ghost_cells : { 0, 1, 5 }) {
      for (int nx : { 1, 4, 5 }) {
...
TEST_CASE("Vector<2> move from unmanaged constructor")
{
  for (int num_components : { 1, 2, 3 }) {
    for (auto num_ghost_cells : { 0, 1, 5 }) {
      for (int nx : { 1, 4, 5 }) {
...
TEST_CASE("Vector<2> move assign from domain constructor")
{
  for (auto mesh_file : { MESHES }) {
    for (int num_components : { 1, 2, 3 }) {
      for (auto num_ghost_cells : { 0, 1, 5 }) {
...
TEST_CASE("Vector<2> move assign from managed constructor")
{
  for (int num_components : { 1, 2, 3 }) {
    for (auto num_ghost_cells : { 0, 1, 5 }) {
      for (int nx : { 1, 4, 5 }) {
...
TEST_CASE("Vector<2> move assign from unmanaged constructor")
{
  for (int num_components : { 1, 2, 3 }) {
    for (auto num_ghost_cells : { 0, 1, 5 }) {
      for (int nx : { 1, 4, 5 }) {
