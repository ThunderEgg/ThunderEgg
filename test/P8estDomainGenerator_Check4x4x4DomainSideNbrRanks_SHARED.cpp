...
{
  // side nbr rank
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Side<3>::east()).rank == domain["bsw_bse"]->rank);
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Side<3>::north()).rank == domain["bsw_bnw"]->rank);
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Side<3>::top()).rank == domain["bsw_tsw"]->rank);

  CHECK(domain["bsw_bse"]->getNormalNbrInfo(Side<3>::west()).rank == domain["bsw_bsw"]->rank);
  ...
  CHECK(domain["bsw_bnw"]->getNormalNbrInfo(Side<3>::south()).rank == domain["bsw_bsw"]->rank);
  ...
  CHECK(domain["bsw_tsw"]->getNormalNbrInfo(Side<3>::bottom()).rank == domain["bsw_bsw"]->rank);
