...
TEST_CASE("P4estDomainGenerator 4x4 Uniform", "[p4estDomGen]")
{
  ...
  // SECTION("nbr_info ids are correct")
  {
    if (rank == 0) {
      ...
      CHECK(domain_2_sw_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_sw_nw_patch->id);
      ...
      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_sw_ne_patch->id);
      ...
      CHECK(domain_2_se_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_se_nw_patch->id);
      ...
      CHECK(domain_2_se_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_se_ne_patch->id);
      ...
      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_sw_sw_patch->id);
      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_nw_sw_patch->id);
      ...
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_sw_se_patch->id);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_nw_se_patch->id);
      ...
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_se_sw_patch->id);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_ne_sw_patch->id);
      ...
      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_se_se_patch->id);
      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_ne_se_patch->id);
      ...
      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_sw_nw_patch->id);
      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_nw_nw_patch->id);
      ...
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_sw_ne_patch->id);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_nw_ne_patch->id);
      ...
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_se_nw_patch->id);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_ne_nw_patch->id);
      ...
      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_se_ne_patch->id);
      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_2_ne_ne_patch->id);
      ...
      CHECK(domain_2_nw_nw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_2_nw_sw_patch->id);
      CHECK_FALSE(domain_2_nw_nw_patch->hasNbr(Side<2>::north()));

      CHECK(domain_2_nw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_nw_nw_patch->rank);
      CHECK(domain_2_nw_ne_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_ne_nw_patch->rank);
      CHECK(domain_2_nw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_nw_se_patch->rank);
      CHECK_FALSE(domain_2_nw_ne_patch->hasNbr(Side<2>::north()));

      CHECK(domain_2_ne_nw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_nw_ne_patch->rank);
      CHECK(domain_2_ne_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_ne_ne_patch->rank);
      CHECK(domain_2_ne_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_ne_sw_patch->rank);
      CHECK_FALSE(domain_2_ne_nw_patch->hasNbr(Side<2>::north()));

      CHECK(domain_2_ne_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_ne_nw_patch->rank);
      CHECK_FALSE(domain_2_ne_ne_patch->hasNbr(Side<2>::east()));
      CHECK(domain_2_ne_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_ne_se_patch->rank);
  ...
  {
    if (rank == 0) {
      CHECK(domain_2_sw_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_sw_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_sw_nw_patch->rank);

      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_sw_sw_patch->rank);
      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_se_sw_patch->rank);
      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_sw_ne_patch->rank);

      CHECK(domain_2_se_sw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_se_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_se_se_patch->rank);
      CHECK(domain_2_se_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_se_nw_patch->rank);

      CHECK(domain_2_se_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_se_sw_patch->rank);
      CHECK(domain_2_se_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_se_ne_patch->rank);

      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_sw_ne_patch->rank);
      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_sw_sw_patch->rank);
      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_nw_sw_patch->rank);

      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_sw_nw_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_se_nw_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_nw_se_patch->rank);

      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_sw_ne_patch->rank);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_se_ne_patch->rank);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_se_sw_patch->rank);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_ne_sw_patch->rank);

      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_se_nw_patch->rank);
      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_se_se_patch->rank);
      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_ne_se_patch->rank);

      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_nw_se_patch->rank);
      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_sw_nw_patch->rank);
      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_nw_nw_patch->rank);

      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_nw_sw_patch->rank);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_ne_sw_patch->rank);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_sw_ne_patch->rank);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_nw_ne_patch->rank);

      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_nw_se_patch->rank);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_ne_se_patch->rank);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_se_nw_patch->rank);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_ne_nw_patch->rank);

      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_ne_sw_patch->rank);
      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_se_ne_patch->rank);
      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_ne_ne_patch->rank);

      CHECK(domain_2_nw_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_2_nw_ne_patch->rank);
      CHECK(domain_2_nw_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_nw_sw_patch->rank);
  ...
  {
    if (rank == 0) {
      CHECK(domain_2_sw_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_sw_ne_patch->rank);

      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_sw_nw_patch->rank);
      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_se_nw_patch->rank);

      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_nw_se_patch->rank);

      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_sw_sw_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_se_sw_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_nw_sw_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_ne_sw_patch->rank);

      CHECK(domain_2_se_sw_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_sw_ne_patch->rank);
      CHECK(domain_2_se_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_se_ne_patch->rank);

      CHECK(domain_2_se_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_se_nw_patch->rank);

      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_se_se_patch->rank);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_nw_se_patch->rank);
      CHECK(domain_2_se_nw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_ne_se_patch->rank);

      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_se_sw_patch->rank);
      CHECK(domain_2_se_ne_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_ne_sw_patch->rank);

      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_sw_ne_patch->rank);
      CHECK(domain_2_nw_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_nw_ne_patch->rank);

      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_sw_nw_patch->rank);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_se_nw_patch->rank);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_nw_nw_patch->rank);
      CHECK(domain_2_nw_se_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_ne_nw_patch->rank);

      CHECK(domain_2_nw_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_nw_se_patch->rank);

      CHECK(domain_2_nw_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_nw_sw_patch->rank);
      CHECK(domain_2_nw_ne_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_ne_sw_patch->rank);

      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_sw_ne_patch->rank);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_se_ne_patch->rank);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_nw_ne_patch->rank);
      CHECK(domain_2_ne_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_2_ne_ne_patch->rank);

      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_se_nw_patch->rank);
      CHECK(domain_2_ne_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_2_ne_nw_patch->rank);

      CHECK(domain_2_ne_nw_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_nw_se_patch->rank);
      CHECK(domain_2_ne_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_2_ne_se_patch->rank);

      CHECK(domain_2_ne_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_ne_sw_patch->rank);
...
TEST_CASE("P4estDomainGenerator 2x2 Refined SW", "[p4estDomGen]")
{
  ...
  // SECTION("nbr_info ranks are correct")
  {
    if (rank == 0) {
      ...
      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_sw_sw_patch->rank);
      CHECK(domain_2_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).rank ==
            domain_2_se_patch->rank);
      CHECK(domain_2_sw_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_2_sw_ne_patch->rank);
      ...
      CHECK(domain_2_sw_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_sw_sw_patch->rank);
      CHECK(domain_2_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).rank ==
            domain_2_nw_patch->rank);

      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_2_sw_nw_patch->rank);
      CHECK(domain_2_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).rank ==
            domain_2_se_patch->rank);
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).rank ==
            domain_2_nw_patch->rank);

      CHECK(domain_2_se_patch->getFineNbrInfo(Side<2>::west()).ranks[0] ==
            domain_2_sw_se_patch->rank);
      CHECK(domain_2_se_patch->getFineNbrInfo(Side<2>::west()).ranks[1] ==
            domain_2_sw_ne_patch->rank);
      ...
      CHECK(domain_2_nw_patch->getFineNbrInfo(Side<2>::south()).ranks[0] ==
            domain_2_sw_nw_patch->rank);
      CHECK(domain_2_nw_patch->getFineNbrInfo(Side<2>::south()).ranks[1] ==
            domain_2_sw_ne_patch->rank);
  ...
  {
    if (rank == 0) {
      CHECK(domain_2_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).orth_on_coarse ==
            Orthant<1>::lower());

      CHECK(domain_2_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).orth_on_coarse ==
            Orthant<1>::lower());

      CHECK(domain_2_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).orth_on_coarse ==
            Orthant<1>::upper());
      CHECK(domain_2_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).orth_on_coarse ==
            Orthant<1>::upper());
    }
  }
  // SECTION("corner_nbr_info ids are correct")
  ...
  // SECTION("corner_nbr_info ranks are correct")
  {
    if (rank == 0) {
      ...
      CHECK(domain_2_sw_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_2_sw_sw_patch->rank);
      CHECK(domain_2_sw_ne_patch->hasNbr(Corner<2>::ne()));
      CHECK(domain_2_sw_ne_patch->getCoarseNbrInfo(Corner<2>::ne()).rank ==
            domain_2_ne_patch->rank);
      ...
      CHECK(domain_2_ne_patch->hasNbr(Corner<2>::sw()));
      CHECK(domain_2_ne_patch->getFineNbrInfo(Corner<2>::sw()).ranks[0] ==
            domain_2_sw_ne_patch->rank);
...
TEST_CASE("P4estDomainGenerator 4x4 Refined SW", "[p4estDomGen]")
{
  ...
  // SECTION("nbr_info ids are correct")
  {
    if (rank == 0) {
      ...
      CHECK(domain_3_sw_sw_sw_patch->getNormalNbrInfo(Side<2>::east()).id ==
            domain_3_sw_sw_se_patch->id);
      CHECK_FALSE(domain_3_sw_sw_sw_patch->hasNbr(Side<2>::south()));
      CHECK(domain_3_sw_sw_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_sw_sw_nw_patch->id);

      CHECK(domain_3_sw_sw_se_patch->getNormalNbrInfo(Side<2>::west()).id ==
            domain_3_sw_sw_sw_patch->id);
      CHECK(domain_3_sw_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).id ==
            domain_3_sw_se_patch->id);
      CHECK_FALSE(domain_3_sw_sw_se_patch->hasNbr(Side<2>::south()));
      CHECK(domain_3_sw_sw_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_sw_sw_ne_patch->id);

      CHECK_FALSE(domain_3_sw_sw_nw_patch->hasNbr(Side<2>::west()));
      CHECK(domain_3_sw_sw_nw_patch->getNormalNbrInfo(Side<2>::east()).id ==
            domain_3_sw_sw_ne_patch->id);
      CHECK(domain_3_sw_sw_nw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_sw_sw_sw_patch->id);
      CHECK(domain_3_sw_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).id ==
            domain_3_sw_nw_patch->id);

      CHECK(domain_3_sw_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).id ==
            domain_3_sw_sw_nw_patch->id);
      CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).id ==
            domain_3_sw_se_patch->id);
      CHECK(domain_3_sw_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_sw_sw_se_patch->id);
      CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).id ==
            domain_3_sw_nw_patch->id);

      CHECK(domain_3_sw_se_patch->getFineNbrInfo(Side<2>::west()).ids[0] ==
            domain_3_sw_sw_se_patch->id);
      CHECK(domain_3_sw_se_patch->getFineNbrInfo(Side<2>::west()).ids[1] ==
            domain_3_sw_sw_ne_patch->id);
      ...
      CHECK(domain_3_sw_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_sw_ne_patch->id);
      ...
      CHECK(domain_3_sw_nw_patch->getFineNbrInfo(Side<2>::south()).ids[0] ==
            domain_3_sw_sw_nw_patch->id);
      CHECK(domain_3_sw_nw_patch->getFineNbrInfo(Side<2>::south()).ids[1] ==
            domain_3_sw_sw_ne_patch->id);
      CHECK(domain_3_sw_nw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_nw_sw_patch->id);
      ...
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_sw_se_patch->id);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_nw_se_patch->id);
      ...
      CHECK(domain_3_se_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_se_nw_patch->id);
      ...
      CHECK(domain_3_se_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_se_ne_patch->id);
      ...
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_se_sw_patch->id);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_ne_sw_patch->id);
      ...
      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_se_se_patch->id);
      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_ne_se_patch->id);
      ...
      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_sw_nw_patch->id);
      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_nw_nw_patch->id);
      ...
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_sw_ne_patch->id);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_nw_ne_patch->id);
      ...
      CHECK(domain_3_nw_nw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_nw_sw_patch->id);
      CHECK_FALSE(domain_3_nw_nw_patch->hasNbr(Side<2>::north()));

      CHECK(domain_3_nw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_nw_nw_patch->rank);
      CHECK(domain_3_nw_ne_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_ne_nw_patch->rank);
      CHECK(domain_3_nw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_nw_se_patch->rank);
      ...
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_se_nw_patch->id);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_ne_nw_patch->id);
      ...
      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Side<2>::south()).id ==
            domain_3_se_ne_patch->id);
      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Side<2>::north()).id ==
            domain_3_ne_ne_patch->id);

      CHECK(domain_3_ne_nw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_nw_ne_patch->rank);
      CHECK(domain_3_ne_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_ne_ne_patch->rank);
      CHECK(domain_3_ne_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_ne_sw_patch->rank);
      CHECK_FALSE(domain_3_ne_nw_patch->hasNbr(Side<2>::north()));

      CHECK(domain_3_ne_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_ne_nw_patch->rank);
      CHECK_FALSE(domain_3_ne_ne_patch->hasNbr(Side<2>::east()));
      CHECK(domain_3_ne_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_ne_se_patch->rank);
  ...
  {
    if (rank == 0) {
      CHECK(domain_3_sw_sw_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_sw_sw_se_patch->rank);
      CHECK(domain_3_sw_sw_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_sw_sw_nw_patch->rank);

      CHECK(domain_3_sw_sw_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_sw_sw_sw_patch->rank);
      CHECK(domain_3_sw_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).rank ==
            domain_3_sw_se_patch->rank);
      CHECK(domain_3_sw_sw_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_sw_sw_ne_patch->rank);

      CHECK(domain_3_sw_sw_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_sw_sw_ne_patch->rank);
      CHECK(domain_3_sw_sw_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_sw_sw_sw_patch->rank);
      CHECK(domain_3_sw_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).rank ==
            domain_3_sw_nw_patch->rank);

      CHECK(domain_3_sw_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_sw_sw_nw_patch->rank);
      CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).rank ==
            domain_3_sw_nw_patch->rank);
      CHECK(domain_3_sw_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_sw_sw_se_patch->rank);
      CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).rank ==
            domain_3_sw_nw_patch->rank);

      CHECK(domain_3_sw_se_patch->getFineNbrInfo(Side<2>::west()).ranks[0] ==
            domain_3_sw_sw_se_patch->rank);
      CHECK(domain_3_sw_se_patch->getFineNbrInfo(Side<2>::west()).ranks[1] ==
            domain_3_sw_sw_ne_patch->rank);
      CHECK(domain_3_sw_se_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_se_sw_patch->rank);
      CHECK(domain_3_sw_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_sw_ne_patch->rank);

      CHECK(domain_3_sw_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_sw_ne_patch->rank);
      CHECK(domain_3_sw_nw_patch->getFineNbrInfo(Side<2>::south()).ranks[0] ==
            domain_3_sw_sw_nw_patch->rank);
      CHECK(domain_3_sw_nw_patch->getFineNbrInfo(Side<2>::south()).ranks[1] ==
            domain_3_sw_sw_ne_patch->rank);
      CHECK(domain_3_sw_nw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_nw_sw_patch->rank);

      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_sw_nw_patch->rank);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_se_nw_patch->rank);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_sw_se_patch->rank);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_nw_se_patch->rank);

      CHECK(domain_3_se_sw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_sw_se_patch->rank);
      CHECK(domain_3_se_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_se_se_patch->rank);
      CHECK(domain_3_se_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_se_nw_patch->rank);

      CHECK(domain_3_se_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_se_sw_patch->rank);
      CHECK(domain_3_se_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_se_ne_patch->rank);

      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_sw_ne_patch->rank);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_se_ne_patch->rank);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_se_sw_patch->rank);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_ne_sw_patch->rank);

      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_se_nw_patch->rank);
      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_se_se_patch->rank);
      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_ne_se_patch->rank);

      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_nw_se_patch->rank);
      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_sw_nw_patch->rank);
      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_nw_nw_patch->rank);

      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_nw_sw_patch->rank);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_ne_sw_patch->rank);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_sw_ne_patch->rank);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_nw_ne_patch->rank);

      CHECK(domain_3_nw_nw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_nw_ne_patch->rank);
      CHECK(domain_3_nw_nw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_nw_sw_patch->rank);
      ...
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_nw_se_patch->rank);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Side<2>::east()).rank ==
            domain_3_ne_se_patch->rank);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_se_nw_patch->rank);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_ne_nw_patch->rank);

      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Side<2>::west()).rank ==
            domain_3_ne_sw_patch->rank);
      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Side<2>::south()).rank ==
            domain_3_se_ne_patch->rank);
      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Side<2>::north()).rank ==
            domain_3_ne_ne_patch->rank);
  ...
  // SECTION("corner_nbr_info ids are correct")
  {
    if (rank == 0) {
      ...
      CHECK(domain_3_sw_sw_sw_patch->getNormalNbrInfo(Corner<2>::ne()).id ==
            domain_3_sw_sw_ne_patch->id);
      ...
      CHECK(domain_3_sw_sw_se_patch->getNormalNbrInfo(Corner<2>::nw()).id ==
            domain_3_sw_sw_nw_patch->id);
      ...
      CHECK(domain_3_sw_sw_nw_patch->getNormalNbrInfo(Corner<2>::se()).id ==
            domain_3_sw_sw_se_patch->id);
      ...
      CHECK(domain_3_sw_sw_ne_patch->getNormalNbrInfo(Corner<2>::sw()).id ==
            domain_3_sw_sw_sw_patch->id);
      ...
      CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Corner<2>::ne()).id ==
            domain_3_sw_ne_patch->id);
      ...
      CHECK(domain_3_sw_ne_patch->getFineNbrInfo(Corner<2>::sw()).ids[0] ==
            domain_3_sw_sw_ne_patch->id);
  ...
  {
    if (rank == 0) {
      CHECK(domain_3_sw_sw_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_sw_sw_ne_patch->rank);

      CHECK(domain_3_sw_sw_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_sw_sw_nw_patch->rank);

      CHECK(domain_3_sw_sw_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_sw_sw_se_patch->rank);

      CHECK(domain_3_sw_sw_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_sw_sw_sw_patch->rank);
      CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Corner<2>::ne()).rank ==
            domain_3_sw_ne_patch->rank);

      CHECK(domain_3_sw_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_sw_nw_patch->rank);
      CHECK(domain_3_sw_se_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_se_nw_patch->rank);

      CHECK(domain_3_sw_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_sw_se_patch->rank);
      CHECK(domain_3_sw_nw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_nw_se_patch->rank);

      CHECK(domain_3_sw_ne_patch->getFineNbrInfo(Corner<2>::sw()).ranks[0] ==
            domain_3_sw_sw_ne_patch->rank);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_se_sw_patch->rank);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_nw_sw_patch->rank);
      CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_ne_sw_patch->rank);

      CHECK(domain_3_se_sw_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_sw_ne_patch->rank);
      CHECK(domain_3_se_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_se_ne_patch->rank);

      CHECK(domain_3_se_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_se_nw_patch->rank);

      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_sw_se_patch->rank);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_se_se_patch->rank);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_nw_se_patch->rank);
      CHECK(domain_3_se_nw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_ne_se_patch->rank);

      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_se_sw_patch->rank);
      CHECK(domain_3_se_ne_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_ne_sw_patch->rank);

      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_sw_ne_patch->rank);
      CHECK(domain_3_nw_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_nw_ne_patch->rank);

      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_sw_nw_patch->rank);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_se_nw_patch->rank);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_nw_nw_patch->rank);
      CHECK(domain_3_nw_se_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_ne_nw_patch->rank);

      CHECK(domain_3_nw_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_nw_se_patch->rank);

      CHECK(domain_3_nw_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_nw_sw_patch->rank);
      CHECK(domain_3_nw_ne_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_ne_sw_patch->rank);

      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_sw_ne_patch->rank);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_se_ne_patch->rank);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_nw_ne_patch->rank);
      CHECK(domain_3_ne_sw_patch->getNormalNbrInfo(Corner<2>::ne()).rank ==
            domain_3_ne_ne_patch->rank);

      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_se_nw_patch->rank);
      CHECK(domain_3_ne_se_patch->getNormalNbrInfo(Corner<2>::nw()).rank ==
            domain_3_ne_nw_patch->rank);

      CHECK(domain_3_ne_nw_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_nw_se_patch->rank);
      CHECK(domain_3_ne_nw_patch->getNormalNbrInfo(Corner<2>::se()).rank ==
            domain_3_ne_se_patch->rank);

      CHECK(domain_3_ne_ne_patch->getNormalNbrInfo(Corner<2>::sw()).rank ==
            domain_3_ne_sw_patch->rank);
