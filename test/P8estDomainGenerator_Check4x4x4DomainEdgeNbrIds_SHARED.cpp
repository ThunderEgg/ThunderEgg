...
{
  // edge nbr id
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Edge::tn()).id == domain["bsw_tnw"]->id);
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Edge::te()).id == domain["bsw_tse"]->id);
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Edge::ne()).id == domain["bsw_bne"]->id);
  ...
  CHECK(domain["bsw_bne"]->getNormalNbrInfo(Edge::sw()).id == domain["bsw_bsw"]->id);
  ...
  CHECK(domain["bsw_tse"]->getNormalNbrInfo(Edge::bw()).id == domain["bsw_bsw"]->id);
  ...
  CHECK(domain["bsw_tnw"]->getNormalNbrInfo(Edge::bs()).id == domain["bsw_bsw"]->id);
