...
TEST_CASE("MultiDimensionalView default constructor", "[MultiDimensionalView]")
{
	MultiDimensionalView<2> v;
...
TEST_CASE("MultiDimensionalView constructor", "[MultiDimensionalView]")
{
	...
	MultiDimensionalView<2> v(&data, {x_stride, y_stride}, {x_ghost_start, y_ghost_start}, {x_start, y_start}, {x_end, y_end}, {x_ghost_end, y_ghost_end});
...
TEST_CASE("MultiDimensionalView squarebracket operator", "[MultiDimensionalView]")
{
	auto x_stride      = GENERATE(1, 2);
...
TEST_CASE("MultiDimensionalView squarebracket operator const", "[MultiDimensionalView]")
{
	auto x_stride      = GENERATE(1, 2);
	auto y_stride      = GENERATE(4, 5);
	auto x_ghost_start = GENERATE(-1, 1);
	...
	const MultiDimensionalView<2> v(data, {x_stride, y_stride}, {x_ghost_start, y_ghost_start}, {x_start, y_start}, {x_end, y_end}, {x_ghost_end, y_ghost_end});
...
TEST_CASE("MultiDimensionalView parens operator", "[MultiDimensionalView]")
{
	auto x_stride      = GENERATE(1, 2);
	auto y_stride      = GENERATE(4, 5);
	auto x_ghost_start = GENERATE(-1, 1);
...
TEST_CASE("MultiDimensionalView parens operator const", "[MultiDimensionalView]")
{
	auto x_stride      = GENERATE(1, 2);
	auto y_stride      = GENERATE(4, 5);
	auto x_ghost_start = GENERATE(-1, 1);
...
TEST_CASE("MultiDimensionalView set", "[MultiDimensionalView]")
{
	auto x_stride      = GENERATE(1, 2);
	auto y_stride      = GENERATE(4, 5);
	auto x_ghost_start = GENERATE(-1, 1);
...
TEST_CASE("MultiDimensionalView set const", "[MultiDimensionalView]")
{
	auto x_stride      = GENERATE(1, 2);
	auto y_stride      = GENERATE(4, 5);
	auto x_ghost_start = GENERATE(-1, 1);
