...
std::vector<ThunderEgg::PatchInfo<3>> GetAllPatchesOnRank0(const ThunderEgg::Domain<3> &domain);
...
void Check2x2x2RefinedBSWDomainNeighbors(const ThunderEgg::Domain<3> &domain);
