...
{
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Edge::tn()).id, domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Edge::te()).id, domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Edge::ne()).id, domain["bsw_bsw_bne"]->id);

  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Edge::tn()).id, domain["bsw_bsw_tne"]->id);
  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Edge::tw()).id, domain["bsw_bsw_tsw"]->id);
  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Edge::nw()).id, domain["bsw_bsw_bnw"]->id);

  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Edge::ts()).id, domain["bsw_bsw_tsw"]->id);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Edge::te()).id, domain["bsw_bsw_tne"]->id);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Edge::se()).id, domain["bsw_bsw_bse"]->id);

  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Edge::ts()).id, domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Edge::tw()).id, domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Edge::sw()).id, domain["bsw_bsw_bsw"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getCoarseNbrInfo(Edge::ne()).id, domain["bsw_bne"]->id);

  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Edge::bn()).id, domain["bsw_bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Edge::be()).id, domain["bsw_bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Edge::ne()).id, domain["bsw_bsw_tne"]->id);

  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Edge::bn()).id, domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Edge::bw()).id, domain["bsw_bsw_bsw"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getCoarseNbrInfo(Edge::te()).id, domain["bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Edge::nw()).id, domain["bsw_bsw_tnw"]->id);

  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Edge::bs()).id, domain["bsw_bsw_bsw"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getCoarseNbrInfo(Edge::tn()).id, domain["bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Edge::be()).id, domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Edge::se()).id, domain["bsw_bsw_tse"]->id);

  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Edge::bs()).id, domain["bsw_bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Edge::tn()).id, domain["bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Edge::bw()).id, domain["bsw_bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Edge::te()).id, domain["bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Edge::sw()).id, domain["bsw_bsw_tsw"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Edge::ne()).id, domain["bsw_bne"]->id);
  ...
  CHECK_EQ(domain["bsw_bne"]->getFineNbrInfo(Edge::sw()).ids[0], domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bne"]->getFineNbrInfo(Edge::sw()).ids[1], domain["bsw_bsw_tne"]->id);
  ...
  CHECK_EQ(domain["bsw_tse"]->getFineNbrInfo(Edge::bw()).ids[0], domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_tse"]->getFineNbrInfo(Edge::bw()).ids[1], domain["bsw_bsw_tne"]->id);
  ...
  CHECK_EQ(domain["bsw_tnw"]->getFineNbrInfo(Edge::bs()).ids[0], domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_tnw"]->getFineNbrInfo(Edge::bs()).ids[1], domain["bsw_bsw_tne"]->id);
