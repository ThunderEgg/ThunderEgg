...
TEST_CASE("P4estDomGen 4x4 Uniform", "[p4estDomGen]")
{
	int rank;
	MPI_Comm_rank(MPI_COMM_WORLD, &rank);
...
TEST_CASE("P4estDomGen 2x2 Refined twice SW", "[p4estDomGen]")
{
	int rank;
	MPI_Comm_rank(MPI_COMM_WORLD, &rank);
	...
	INFO("Domain 3:\n"
	     << GetAllPatchesJSONString(domain_3_patches));
	INFO("Domain 2:\n"
	     << GetAllPatchesJSONString(domain_2_patches));
	INFO("Domain 1:\n"
	     << GetAllPatchesJSONString(domain_1_patches));
	...
	const PatchInfo<2> *domain_3_se_patch       = nullptr;
	const PatchInfo<2> *domain_3_nw_patch       = nullptr;
	const PatchInfo<2> *domain_3_ne_patch       = nullptr;
	...
	if (rank == 0) {
		for (PatchInfo<2> &patch : domain_3_patches) {
			...
			if (x == Catch::Approx(0.5 * scale_x) && y == Catch::Approx(0)) {
				domain_3_se_patch = &patch;
			}
			if (x == Catch::Approx(0) && y == Catch::Approx(0.5 * scale_y)) {
				domain_3_nw_patch = &patch;
			}
			if (x == Catch::Approx(0.5 * scale_x) && y == Catch::Approx(0.5 * scale_y)) {
				domain_3_ne_patch = &patch;
			}
		}
		...
		REQUIRE(domain_3_se_patch != nullptr);
		REQUIRE(domain_3_nw_patch != nullptr);
		REQUIRE(domain_3_ne_patch != nullptr);
	...
	SECTION("patches have correct spacings")
	{
		if (rank == 0) {
			...
			CHECK(domain_3_se_patch->spacings[0] == Catch::Approx(scale_x * 0.5 / nx));
			CHECK(domain_3_se_patch->spacings[1] == Catch::Approx(scale_y * 0.5 / ny));
			CHECK(domain_3_nw_patch->spacings[0] == Catch::Approx(scale_x * 0.5 / nx));
			CHECK(domain_3_nw_patch->spacings[1] == Catch::Approx(scale_y * 0.5 / ny));
			CHECK(domain_3_ne_patch->spacings[0] == Catch::Approx(scale_x * 0.5 / nx));
			CHECK(domain_3_ne_patch->spacings[1] == Catch::Approx(scale_y * 0.5 / ny));
	...
	SECTION("patches have refine_level set")
	{
		if (rank == 0) {
			...
			CHECK(domain_3_se_patch->refine_level == 1);
			CHECK(domain_3_nw_patch->refine_level == 1);
			CHECK(domain_3_ne_patch->refine_level == 1);
	...
	SECTION("parent ids are set correctly")
	{
		if (rank == 0) {
			...
			CHECK(domain_3_se_patch->parent_id == domain_2_se_patch->id);
			CHECK(domain_3_nw_patch->parent_id == domain_2_nw_patch->id);
			CHECK(domain_3_ne_patch->parent_id == domain_2_ne_patch->id);
	...
	SECTION("child ids are set correctly")
	{
		if (rank == 0) {
			for (int i = 0; i < 4; i++) {
				...
				CHECK(domain_3_se_patch->child_ids[i] == -1);
				CHECK(domain_3_nw_patch->child_ids[i] == -1);
				CHECK(domain_3_ne_patch->child_ids[i] == -1);
			}
			...
			CHECK(domain_2_se_patch->child_ids[0] == domain_3_se_patch->id);
			CHECK(domain_2_nw_patch->child_ids[0] == domain_3_nw_patch->id);
			CHECK(domain_2_ne_patch->child_ids[0] == domain_3_ne_patch->id);
	...
	SECTION("orth on parent is set correctly")
	{
		if (rank == 0) {
			...
			CHECK(domain_3_se_patch->orth_on_parent == Orthant<2>::null());
			CHECK(domain_3_nw_patch->orth_on_parent == Orthant<2>::null());
			CHECK(domain_3_ne_patch->orth_on_parent == Orthant<2>::null());
	...
	SECTION("child ranks are set correctly")
	{
		if (rank == 0) {
			for (int i = 0; i < 4; i++) {
				...
				CHECK(domain_3_se_patch->child_ranks[i] == -1);
				CHECK(domain_3_nw_patch->child_ranks[i] == -1);
				CHECK(domain_3_ne_patch->child_ranks[i] == -1);
			}
			...
			CHECK(domain_2_se_patch->child_ranks[0] == domain_3_se_patch->rank);
			CHECK(domain_2_nw_patch->child_ranks[0] == domain_3_nw_patch->rank);
			CHECK(domain_2_ne_patch->child_ranks[0] == domain_3_ne_patch->rank);
	...
	SECTION("nbr_info ids are correct")
	{
		if (rank == 0) {
			...
			CHECK(domain_3_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).id == domain_3_se_patch->id);
			...
			CHECK(domain_3_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).id == domain_3_nw_patch->id);

			CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).id == domain_3_sw_nw_patch->id);
			CHECK(domain_3_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).id == domain_3_se_patch->id);
			CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).id == domain_3_sw_se_patch->id);
			CHECK(domain_3_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).id == domain_3_nw_patch->id);

			CHECK(domain_3_se_patch->getFineNbrInfo(Side<2>::west()).ids[0] == domain_3_sw_se_patch->id);
			CHECK(domain_3_se_patch->getFineNbrInfo(Side<2>::west()).ids[1] == domain_3_sw_ne_patch->id);
			CHECK_FALSE(domain_3_se_patch->hasNbr(Side<2>::east()));
			CHECK_FALSE(domain_3_se_patch->hasNbr(Side<2>::south()));
			CHECK(domain_3_se_patch->getNormalNbrInfo(Side<2>::north()).id == domain_3_ne_patch->id);

			CHECK_FALSE(domain_3_nw_patch->hasNbr(Side<2>::west()));
			CHECK(domain_3_nw_patch->getNormalNbrInfo(Side<2>::east()).id == domain_3_ne_patch->id);
			CHECK(domain_3_nw_patch->getFineNbrInfo(Side<2>::south()).ids[0] == domain_3_sw_nw_patch->id);
			CHECK(domain_3_nw_patch->getFineNbrInfo(Side<2>::south()).ids[1] == domain_3_sw_ne_patch->id);
			CHECK_FALSE(domain_3_nw_patch->hasNbr(Side<2>::north()));

			CHECK(domain_3_ne_patch->getNormalNbrInfo(Side<2>::west()).id == domain_3_nw_patch->id);
			CHECK_FALSE(domain_3_ne_patch->hasNbr(Side<2>::east()));
			CHECK(domain_3_ne_patch->getNormalNbrInfo(Side<2>::south()).id == domain_3_se_patch->id);
			CHECK_FALSE(domain_3_ne_patch->hasNbr(Side<2>::north()));
	...
	SECTION("nbr_info ranks are correct")
	{
		if (rank == 0) {
			...
			CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).rank == domain_3_sw_se_patch->rank);
			...
			CHECK(domain_3_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).rank == domain_3_se_patch->rank);
			...
			CHECK(domain_3_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).rank == domain_3_nw_patch->rank);

			CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::west()).rank == domain_3_sw_nw_patch->rank);
			CHECK(domain_3_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).rank == domain_3_se_patch->rank);
			CHECK(domain_3_sw_ne_patch->getNormalNbrInfo(Side<2>::south()).rank == domain_3_sw_se_patch->rank);
			CHECK(domain_3_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).rank == domain_3_nw_patch->rank);

			CHECK(domain_3_se_patch->getFineNbrInfo(Side<2>::west()).ranks[0] == domain_3_sw_se_patch->rank);
			CHECK(domain_3_se_patch->getFineNbrInfo(Side<2>::west()).ranks[1] == domain_3_sw_ne_patch->rank);
			CHECK(domain_3_se_patch->getNormalNbrInfo(Side<2>::north()).rank == domain_3_ne_patch->rank);

			CHECK(domain_3_nw_patch->getNormalNbrInfo(Side<2>::east()).rank == domain_3_ne_patch->rank);
			CHECK(domain_3_nw_patch->getFineNbrInfo(Side<2>::south()).ranks[0] == domain_3_sw_nw_patch->rank);
			CHECK(domain_3_nw_patch->getFineNbrInfo(Side<2>::south()).ranks[1] == domain_3_sw_ne_patch->rank);
	...
	{
		if (rank == 0) {
			CHECK(domain_3_sw_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).orth_on_coarse == Orthant<1>::lower());

			CHECK(domain_3_sw_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).orth_on_coarse == Orthant<1>::lower());

			CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).orth_on_coarse == Orthant<1>::upper());
			CHECK(domain_3_sw_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).orth_on_coarse == Orthant<1>::upper());

			CHECK(domain_3_sw_se_patch->getCoarseNbrInfo(Side<2>::east()).orth_on_coarse == Orthant<1>::lower());

			CHECK(domain_3_sw_nw_patch->getCoarseNbrInfo(Side<2>::north()).orth_on_coarse == Orthant<1>::lower());

			CHECK(domain_3_sw_ne_patch->getCoarseNbrInfo(Side<2>::east()).orth_on_coarse == Orthant<1>::upper());
			CHECK(domain_3_sw_ne_patch->getCoarseNbrInfo(Side<2>::north()).orth_on_coarse == Orthant<1>::upper());
...
TEST_CASE("P4estDomGen 4x4 Refined SW", "[p4estDomGen]")
{
	int rank;
	MPI_Comm_rank(MPI_COMM_WORLD, &rank);
	p4est_connectivity_t *conn = p4est_connectivity_new_unitsquare();
