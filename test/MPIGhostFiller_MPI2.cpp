...
TEST_CASE("Calls for various domains 1-side cases MPI2", "[MPIGhostFiller]")
{
...
TEST_CASE("Exchange for various domains 1-side cases MPI2", "[MPIGhostFiller]")
{
	auto mesh_file = GENERATE(as<std::string>{}, uniform, refined);
	INFO("MESH: " << mesh_file);
	auto                  nx        = GENERATE(2, 5);
...
TEST_CASE("Two Exchanges for various domains 1-side cases MPI2", "[MPIGhostFiller]")
{
	auto mesh_file = GENERATE(as<std::string>{}, uniform, refined);
	INFO("MESH: " << mesh_file);
	auto                  nx        = GENERATE(2, 5);
