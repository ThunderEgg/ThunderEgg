...
{
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Side<3>::east()).rank, domain["bsw_bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Side<3>::north()).rank, domain["bsw_bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Side<3>::top()).rank, domain["bsw_bsw_tsw"]->rank);

  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Side<3>::west()).rank, domain["bsw_bsw_bsw"]->rank);
  CHECK_EQ(domain["bsw_bsw_bse"]->getCoarseNbrInfo(Side<3>::east()).rank, domain["bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Side<3>::north()).rank, domain["bsw_bsw_bne"]->rank);
  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Side<3>::top()).rank, domain["bsw_bsw_tse"]->rank);

  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Side<3>::east()).rank, domain["bsw_bsw_bne"]->rank);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Side<3>::south()).rank, domain["bsw_bsw_bsw"]->rank);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getCoarseNbrInfo(Side<3>::north()).rank, domain["bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Side<3>::top()).rank, domain["bsw_bsw_tnw"]->rank);

  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Side<3>::west()).rank, domain["bsw_bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_bne"]->getCoarseNbrInfo(Side<3>::east()).rank, domain["bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Side<3>::south()).rank, domain["bsw_bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_bne"]->getCoarseNbrInfo(Side<3>::north()).rank, domain["bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Side<3>::top()).rank, domain["bsw_bsw_tne"]->rank);

  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Side<3>::east()).rank, domain["bsw_bsw_tse"]->rank);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Side<3>::north()).rank, domain["bsw_bsw_tnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Side<3>::bottom()).rank, domain["bsw_bsw_bsw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getCoarseNbrInfo(Side<3>::top()).rank, domain["bsw_tsw"]->rank);

  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Side<3>::west()).rank, domain["bsw_bsw_tsw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tse"]->getCoarseNbrInfo(Side<3>::east()).rank, domain["bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Side<3>::north()).rank, domain["bsw_bsw_tne"]->rank);
  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Side<3>::bottom()).rank, domain["bsw_bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_tse"]->getCoarseNbrInfo(Side<3>::top()).rank, domain["bsw_tsw"]->rank);

  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Side<3>::east()).rank, domain["bsw_bsw_tne"]->rank);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Side<3>::south()).rank, domain["bsw_bsw_tsw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getCoarseNbrInfo(Side<3>::north()).rank, domain["bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Side<3>::bottom()).rank, domain["bsw_bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getCoarseNbrInfo(Side<3>::top()).rank, domain["bsw_tsw"]->rank);

  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Side<3>::west()).rank, domain["bsw_bsw_tnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Side<3>::east()).rank, domain["bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Side<3>::south()).rank, domain["bsw_bsw_tse"]->rank);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Side<3>::north()).rank, domain["bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Side<3>::bottom()).rank, domain["bsw_bsw_bne"]->rank);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Side<3>::top()).rank, domain["bsw_tsw"]->rank);

  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ranks[0], domain["bsw_bsw_bse"]->rank);
  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ranks[1], domain["bsw_bsw_bne"]->rank);
  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ranks[2], domain["bsw_bsw_tse"]->rank);
  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ranks[3], domain["bsw_bsw_tne"]->rank);
  ...
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ranks[0], domain["bsw_bsw_bnw"]->rank);
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ranks[1], domain["bsw_bsw_bne"]->rank);
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ranks[2], domain["bsw_bsw_tnw"]->rank);
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ranks[3], domain["bsw_bsw_tne"]->rank);
  ...
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ranks[0], domain["bsw_bsw_tsw"]->rank);
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ranks[1], domain["bsw_bsw_tse"]->rank);
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ranks[2], domain["bsw_bsw_tnw"]->rank);
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ranks[3], domain["bsw_bsw_tne"]->rank);
