...
TEST_CASE("P8est SinglePatch", "[P8estDomainGenerator]")
{
	...
	CHECK_FALSE(patch.hasNbr(Edge<3>::bs()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::tn()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::bn()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::ts()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::bw()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::te()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::be()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::tw()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::sw()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::ne()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::se()));
	CHECK_FALSE(patch.hasNbr(Edge<3>::nw()));
...
TEST_CASE("P8estDomainGenerator 2x2 Refined SW", "[P8estDomainGenerator]")
{
	...
	SECTION("edge_nbr_info ids are correct")
	{
		...
		CHECK_FALSE(domain_2_bsw_bse_patch->hasNbr(Edge<3>::te()));
		...
		CHECK_FALSE(domain_2_bsw_bse_patch->hasNbr(Edge<3>::ne()));
		...
		CHECK_FALSE(domain_2_bsw_bnw_patch->hasNbr(Edge<3>::tn()));
		...
		CHECK_FALSE(domain_2_bsw_bnw_patch->hasNbr(Edge<3>::ne()));
		...
		CHECK_FALSE(domain_2_bsw_bne_patch->hasNbr(Edge<3>::tn()));
		...
		CHECK_FALSE(domain_2_bsw_bne_patch->hasNbr(Edge<3>::te()));
		...
		CHECK(domain_2_bsw_bne_patch->getCoarseNbrInfo(Edge<3>::ne()).id == domain_2_bne_patch->id);
		CHECK_FALSE(domain_2_bsw_bne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_bsw_bne_patch->hasNbr(Edge<3>::nw()));

		CHECK_FALSE(domain_2_bsw_tsw_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_2_bsw_tsw_patch->hasNbr(Edge<3>::tn()));
		...
		CHECK_FALSE(domain_2_bsw_tsw_patch->hasNbr(Edge<3>::te()));
		...
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::tn()));
		...
		CHECK(domain_2_bsw_tse_patch->getCoarseNbrInfo(Edge<3>::te()).id == domain_2_tse_patch->id);
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::ne()));
		...
		CHECK(domain_2_bsw_tnw_patch->getCoarseNbrInfo(Edge<3>::tn()).id == domain_2_tnw_patch->id);
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::te()));
		...
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::ne()));
		...
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::tn()).id == domain_2_tnw_patch->id);
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::ts()));
		...
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::te()).id == domain_2_tse_patch->id);
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::tw()));
		...
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::ne()).id == domain_2_bne_patch->id);
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::nw()));

		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::bs()));
		CHECK(domain_2_bse_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_bse_patch->getNormalNbrInfo(Edge<3>::tn()).id == domain_2_tne_patch->id);
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_bse_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_bse_patch->getNormalNbrInfo(Edge<3>::tw()).id == domain_2_tsw_patch->id);
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_bse_patch->hasNbr(Edge<3>::nw()));
		CHECK(domain_2_bse_patch->getNormalNbrInfo(Edge<3>::nw()).id == domain_2_bnw_patch->id);

		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_bnw_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_bnw_patch->getNormalNbrInfo(Edge<3>::ts()).id == domain_2_tsw_patch->id);
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_bnw_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_bnw_patch->getNormalNbrInfo(Edge<3>::te()).id == domain_2_tne_patch->id);
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_bnw_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_bnw_patch->getNormalNbrInfo(Edge<3>::se()).id == domain_2_bse_patch->id);
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::nw()));

		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_bne_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_bne_patch->getNormalNbrInfo(Edge<3>::ts()).id == domain_2_tse_patch->id);
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_bne_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_bne_patch->getNormalNbrInfo(Edge<3>::tw()).id == domain_2_tnw_patch->id);
		CHECK(domain_2_bne_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_bne_patch->getFineNbrInfo(Edge<3>::sw()).ids[0] == domain_2_bsw_bne_patch->id);
		CHECK(domain_2_bne_patch->getFineNbrInfo(Edge<3>::sw()).ids[1] == domain_2_bsw_tne_patch->id);
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::nw()));

		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_tsw_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_tsw_patch->getNormalNbrInfo(Edge<3>::bn()).id == domain_2_bnw_patch->id);
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_tsw_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_tsw_patch->getNormalNbrInfo(Edge<3>::be()).id == domain_2_bse_patch->id);
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_tsw_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_tsw_patch->getNormalNbrInfo(Edge<3>::ne()).id == domain_2_tne_patch->id);
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::nw()));

		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_tse_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_tse_patch->getNormalNbrInfo(Edge<3>::bn()).id == domain_2_bne_patch->id);
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_tse_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_tse_patch->getFineNbrInfo(Edge<3>::bw()).ids[0] == domain_2_bsw_tse_patch->id);
		CHECK(domain_2_tse_patch->getFineNbrInfo(Edge<3>::bw()).ids[1] == domain_2_bsw_tne_patch->id);
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_tse_patch->hasNbr(Edge<3>::nw()));
		CHECK(domain_2_tse_patch->getNormalNbrInfo(Edge<3>::nw()).id == domain_2_tnw_patch->id);

		CHECK(domain_2_tnw_patch->hasNbr(Edge<3>::bs()));
		CHECK(domain_2_tnw_patch->getFineNbrInfo(Edge<3>::bs()).ids[0] == domain_2_bsw_tnw_patch->id);
		CHECK(domain_2_tnw_patch->getFineNbrInfo(Edge<3>::bs()).ids[1] == domain_2_bsw_tne_patch->id);
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_tnw_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_tnw_patch->getNormalNbrInfo(Edge<3>::be()).id == domain_2_bne_patch->id);
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_tnw_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_tnw_patch->getNormalNbrInfo(Edge<3>::se()).id == domain_2_tse_patch->id);
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::nw()));

		CHECK(domain_2_tne_patch->hasNbr(Edge<3>::bs()));
		CHECK(domain_2_tne_patch->getNormalNbrInfo(Edge<3>::bs()).id == domain_2_bse_patch->id);
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_tne_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_tne_patch->getNormalNbrInfo(Edge<3>::bw()).id == domain_2_bnw_patch->id);
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_tne_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_tne_patch->getNormalNbrInfo(Edge<3>::sw()).id == domain_2_tsw_patch->id);
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::nw()));
		...
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_0_patch->hasNbr(Edge<3>::nw()));
	}
	SECTION("edge_nbr_info ranks are correct")
	{
		CHECK_FALSE(domain_2_bsw_bsw_patch->hasNbr(Edge<3>::bs()));
		...
		CHECK(domain_2_bsw_bne_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_bsw_bne_patch->getCoarseNbrInfo(Edge<3>::ne()).rank == domain_2_bne_patch->rank);
		CHECK_FALSE(domain_2_bsw_bne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_bsw_bne_patch->hasNbr(Edge<3>::nw()));
		...
		CHECK(domain_2_bsw_tse_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_bsw_tse_patch->getCoarseNbrInfo(Edge<3>::te()).rank == domain_2_tse_patch->rank);
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_bsw_tse_patch->hasNbr(Edge<3>::ne()));
		...
		CHECK(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_bsw_tnw_patch->getCoarseNbrInfo(Edge<3>::tn()).rank == domain_2_tnw_patch->rank);
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_bsw_tnw_patch->hasNbr(Edge<3>::te()));
		...
		CHECK(domain_2_bsw_tne_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::tn()).rank == domain_2_tnw_patch->rank);
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_bsw_tne_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_bsw_tne_patch->getNormalNbrInfo(Edge<3>::bw()).rank == domain_2_bsw_bnw_patch->rank);
		CHECK(domain_2_bsw_tne_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::te()).rank == domain_2_tse_patch->rank);
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_bsw_tne_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_bsw_tne_patch->getNormalNbrInfo(Edge<3>::sw()).rank == domain_2_bsw_tsw_patch->rank);
		CHECK(domain_2_bsw_tne_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::ne()).rank == domain_2_bne_patch->rank);
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_bsw_tne_patch->hasNbr(Edge<3>::nw()));

		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::bs()));
		CHECK(domain_2_bse_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_bse_patch->getNormalNbrInfo(Edge<3>::tn()).rank == domain_2_tne_patch->rank);
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_bse_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_bse_patch->getNormalNbrInfo(Edge<3>::tw()).rank == domain_2_tsw_patch->rank);
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_bse_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_bse_patch->hasNbr(Edge<3>::nw()));
		CHECK(domain_2_bse_patch->getNormalNbrInfo(Edge<3>::nw()).rank == domain_2_bnw_patch->rank);

		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::bs()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_bnw_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_bnw_patch->getNormalNbrInfo(Edge<3>::ts()).rank == domain_2_tsw_patch->rank);
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_bnw_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_bnw_patch->getNormalNbrInfo(Edge<3>::te()).rank == domain_2_tne_patch->rank);
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_bnw_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_bnw_patch->getNormalNbrInfo(Edge<3>::se()).rank == domain_2_bse_patch->rank);
		CHECK_FALSE(domain_2_bnw_patch->hasNbr(Edge<3>::nw()));
		...
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_bne_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_bne_patch->getNormalNbrInfo(Edge<3>::ts()).rank == domain_2_tse_patch->rank);
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_bne_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_bne_patch->getNormalNbrInfo(Edge<3>::tw()).rank == domain_2_tnw_patch->rank);
		CHECK(domain_2_bne_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_bne_patch->getFineNbrInfo(Edge<3>::sw()).ranks[0] == domain_2_bsw_bne_patch->rank);
		CHECK(domain_2_bne_patch->getFineNbrInfo(Edge<3>::sw()).ranks[1] == domain_2_bsw_tne_patch->rank);
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_bne_patch->hasNbr(Edge<3>::nw()));
		...
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_tsw_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_tsw_patch->getNormalNbrInfo(Edge<3>::bn()).rank == domain_2_bnw_patch->rank);
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_tsw_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_tsw_patch->getNormalNbrInfo(Edge<3>::be()).rank == domain_2_bse_patch->rank);
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_tsw_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_tsw_patch->getNormalNbrInfo(Edge<3>::ne()).rank == domain_2_tne_patch->rank);
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_tsw_patch->hasNbr(Edge<3>::nw()));
		...
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::tn()));
		CHECK(domain_2_tse_patch->hasNbr(Edge<3>::bn()));
		CHECK(domain_2_tse_patch->getNormalNbrInfo(Edge<3>::bn()).rank == domain_2_bne_patch->rank);
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_tse_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_tse_patch->getFineNbrInfo(Edge<3>::bw()).ranks[0] == domain_2_bsw_tse_patch->rank);
		CHECK(domain_2_tse_patch->getFineNbrInfo(Edge<3>::bw()).ranks[1] == domain_2_bsw_tne_patch->rank);
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::sw()));
		...
		CHECK_FALSE(domain_2_tse_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_tse_patch->hasNbr(Edge<3>::nw()));
		CHECK(domain_2_tse_patch->getNormalNbrInfo(Edge<3>::nw()).rank == domain_2_tnw_patch->rank);

		CHECK(domain_2_tnw_patch->hasNbr(Edge<3>::bs()));
		CHECK(domain_2_tnw_patch->getFineNbrInfo(Edge<3>::bs()).ranks[0] == domain_2_bsw_tnw_patch->rank);
		CHECK(domain_2_tnw_patch->getFineNbrInfo(Edge<3>::bs()).ranks[1] == domain_2_bsw_tne_patch->rank);
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::ts()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::bw()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::te()));
		CHECK(domain_2_tnw_patch->hasNbr(Edge<3>::be()));
		CHECK(domain_2_tnw_patch->getNormalNbrInfo(Edge<3>::be()).rank == domain_2_bne_patch->rank);
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::tw()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::sw()));
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::ne()));
		CHECK(domain_2_tnw_patch->hasNbr(Edge<3>::se()));
		CHECK(domain_2_tnw_patch->getNormalNbrInfo(Edge<3>::se()).rank == domain_2_tse_patch->rank);
		CHECK_FALSE(domain_2_tnw_patch->hasNbr(Edge<3>::nw()));

		CHECK(domain_2_tne_patch->hasNbr(Edge<3>::bs()));
		CHECK(domain_2_tne_patch->getNormalNbrInfo(Edge<3>::bs()).rank == domain_2_bse_patch->rank);
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::tn()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::bn()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::ts()));
		CHECK(domain_2_tne_patch->hasNbr(Edge<3>::bw()));
		CHECK(domain_2_tne_patch->getNormalNbrInfo(Edge<3>::bw()).rank == domain_2_bnw_patch->rank);
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::te()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::be()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::tw()));
		CHECK(domain_2_tne_patch->hasNbr(Edge<3>::sw()));
		CHECK(domain_2_tne_patch->getNormalNbrInfo(Edge<3>::sw()).rank == domain_2_tsw_patch->rank);
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::ne()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::se()));
		CHECK_FALSE(domain_2_tne_patch->hasNbr(Edge<3>::nw()));
	...
	SECTION("edge_nbr_info ranks are correct")
	{
		CHECK(domain_2_bsw_tnw_patch->getCoarseNbrInfo(Edge<3>::tn()).orth_on_coarse == Orthant<1>::lower());
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::tn()).orth_on_coarse == Orthant<1>::upper());

		CHECK(domain_2_bsw_tse_patch->getCoarseNbrInfo(Edge<3>::te()).orth_on_coarse == Orthant<1>::lower());
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::te()).orth_on_coarse == Orthant<1>::upper());

		CHECK(domain_2_bsw_bne_patch->getCoarseNbrInfo(Edge<3>::ne()).orth_on_coarse == Orthant<1>::lower());
		CHECK(domain_2_bsw_tne_patch->getCoarseNbrInfo(Edge<3>::ne()).orth_on_coarse == Orthant<1>::upper());
	}
	SECTION("corner_nbr_info ids are correct")
	{
