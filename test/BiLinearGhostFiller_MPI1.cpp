...
TEST_CASE("Test BiLinearGhostFiller::Generator", "[Poisson::StarPatchOperator]")
{
	auto mesh_file
	= GENERATE(as<std::string>{}, single_mesh_file, refined_mesh_file, cross_mesh_file);
	...
	auto blgf_fine = make_shared<BiLinearGhostFiller>(d_fine);
	auto blgf_gen  = BiLinearGhostFiller::Generator(blgf_fine);
