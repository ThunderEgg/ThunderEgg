...
{
  // corner nbr ranks
  CHECK_EQ(domain["bsw_bsw"]->getNormalNbrInfo(Corner<3>::tne()).rank, domain["bsw_tne"]->rank);
  ...
  CHECK_EQ(domain["bsw_tne"]->getNormalNbrInfo(Corner<3>::bsw()).rank, domain["bsw_bsw"]->rank);
