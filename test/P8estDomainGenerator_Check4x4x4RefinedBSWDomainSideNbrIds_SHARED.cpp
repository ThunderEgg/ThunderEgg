...
void
Check4x4x4RefinedBSWDomainSideNeighborIds(const PatchVector& domain)
{
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Side<3>::east()).id, domain["bsw_bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Side<3>::north()).id, domain["bsw_bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_bsw"]->getNormalNbrInfo(Side<3>::top()).id, domain["bsw_bsw_tsw"]->id);

  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Side<3>::west()).id, domain["bsw_bsw_bsw"]->id);
  CHECK_EQ(domain["bsw_bsw_bse"]->getCoarseNbrInfo(Side<3>::east()).id, domain["bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Side<3>::north()).id, domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bsw_bse"]->getNormalNbrInfo(Side<3>::top()).id, domain["bsw_bsw_tse"]->id);

  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Side<3>::east()).id, domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Side<3>::south()).id, domain["bsw_bsw_bsw"]->id);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getCoarseNbrInfo(Side<3>::north()).id, domain["bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_bnw"]->getNormalNbrInfo(Side<3>::top()).id, domain["bsw_bsw_tnw"]->id);

  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Side<3>::west()).id, domain["bsw_bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getCoarseNbrInfo(Side<3>::east()).id, domain["bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Side<3>::south()).id, domain["bsw_bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getCoarseNbrInfo(Side<3>::north()).id, domain["bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_bne"]->getNormalNbrInfo(Side<3>::top()).id, domain["bsw_bsw_tne"]->id);

  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Side<3>::east()).id, domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Side<3>::north()).id, domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getNormalNbrInfo(Side<3>::bottom()).id, domain["bsw_bsw_bsw"]->id);
  CHECK_EQ(domain["bsw_bsw_tsw"]->getCoarseNbrInfo(Side<3>::top()).id, domain["bsw_tsw"]->id);

  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Side<3>::west()).id, domain["bsw_bsw_tsw"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getCoarseNbrInfo(Side<3>::east()).id, domain["bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Side<3>::north()).id, domain["bsw_bsw_tne"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getNormalNbrInfo(Side<3>::bottom()).id, domain["bsw_bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_tse"]->getCoarseNbrInfo(Side<3>::top()).id, domain["bsw_tsw"]->id);

  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Side<3>::east()).id, domain["bsw_bsw_tne"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Side<3>::south()).id, domain["bsw_bsw_tsw"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getCoarseNbrInfo(Side<3>::north()).id, domain["bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getNormalNbrInfo(Side<3>::bottom()).id, domain["bsw_bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tnw"]->getCoarseNbrInfo(Side<3>::top()).id, domain["bsw_tsw"]->id);

  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Side<3>::west()).id, domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Side<3>::east()).id, domain["bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Side<3>::south()).id, domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Side<3>::north()).id, domain["bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getNormalNbrInfo(Side<3>::bottom()).id, domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bsw_tne"]->getCoarseNbrInfo(Side<3>::top()).id, domain["bsw_tsw"]->id);

  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ids[0], domain["bsw_bsw_bse"]->id);
  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ids[1], domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ids[2], domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_bse"]->getFineNbrInfo(Side<3>::west()).ids[3], domain["bsw_bsw_tne"]->id);
  ...
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ids[0], domain["bsw_bsw_bnw"]->id);
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ids[1], domain["bsw_bsw_bne"]->id);
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ids[2], domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_bnw"]->getFineNbrInfo(Side<3>::south()).ids[3], domain["bsw_bsw_tne"]->id);
  ...
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ids[0], domain["bsw_bsw_tsw"]->id);
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ids[1], domain["bsw_bsw_tse"]->id);
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ids[2], domain["bsw_bsw_tnw"]->id);
  CHECK_EQ(domain["bsw_tsw"]->getFineNbrInfo(Side<3>::bottom()).ids[3], domain["bsw_bsw_tne"]->id);
