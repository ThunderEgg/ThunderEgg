...
{
  // edge nbr rank
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Edge::tn()).rank == domain["bsw_tnw"]->rank);
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Edge::te()).rank == domain["bsw_tse"]->rank);
  CHECK(domain["bsw_bsw"]->getNormalNbrInfo(Edge::ne()).rank == domain["bsw_bne"]->rank);
  ...
  CHECK(domain["bsw_bne"]->getNormalNbrInfo(Edge::sw()).rank == domain["bsw_bsw"]->rank);
  ...
  CHECK(domain["bsw_tse"]->getNormalNbrInfo(Edge::bw()).rank == domain["bsw_bsw"]->rank);
  ...
  CHECK(domain["bsw_tnw"]->getNormalNbrInfo(Edge::bs()).rank == domain["bsw_bsw"]->rank);
