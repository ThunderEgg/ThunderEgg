...
{
  // side hasnbr
  CHECK_EQ(domain["bsw_bsw"]->hasNbr(Side<3>::west()), false);
  CHECK_EQ(domain["bsw_bsw"]->hasNbr(Side<3>::east()), true);
  CHECK_EQ(domain["bsw_bsw"]->hasNbr(Side<3>::south()), false);
  CHECK_EQ(domain["bsw_bsw"]->hasNbr(Side<3>::north()), true);
  CHECK_EQ(domain["bsw_bsw"]->hasNbr(Side<3>::bottom()), false);
  CHECK_EQ(domain["bsw_bsw"]->hasNbr(Side<3>::top()), true);
