...
#ifndef THUNDEREGG_CONSTVIEW_H
#define THUNDEREGG_CONSTVIEW_H
 ...
 */
template <int D> class ConstView
{
	private:
	/**
...
extern template class ConstView<1>;
extern template class ConstView<2>;
extern template class ConstView<3>;
extern template class ConstView<4>;
} // namespace ThunderEgg
#endif