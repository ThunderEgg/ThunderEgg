 ...
 */
template <int D> class MultiDimensionalView
{
	private:
	/**
	 ...
	 */
	MultiDimensionalView(double *                           data,
	...
	const std::shared_ptr<const ViewManager> getViewDataManager() const
	{
		return ldm;
	}
};
extern template class MultiDimensionalView<1>;
extern template class MultiDimensionalView<2>;
extern template class MultiDimensionalView<3>;
extern template class MultiDimensionalView<4>;
} // namespace ThunderEgg
#endif