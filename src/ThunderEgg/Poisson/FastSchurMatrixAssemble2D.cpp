 ...
 */
PatchView<double, 2>
getPatchViewForBuffer(double* buffer_ptr, const PatchInfo<2>& pinfo, const Side<2> side)
{
  auto ns = pinfo.ns;
 ...
 */
vector<set<Block>>
GetBlocks(const InterfaceDomain<2>& iface_domain, std::bitset<4> neumann)
{
...
void
FillBlockCoeffs(CoeffMap coeffs, const PatchInfo<2>& pinfo, Poisson::FFTWPatchSolver<2>& solver)
{
