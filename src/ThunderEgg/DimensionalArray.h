...
/**
 * @brief A dimensional array, used for storing templated with and integer. For example a
 * dimensional array of length 3 holding type T will have three values T<0> at index 0, T<1> at
 * index 1, and T<2> at index 2.
 *
