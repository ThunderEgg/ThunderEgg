...
if(BUILD_SHARED_LIBS)
  ...
  list(APPEND P4EST_LIBRARIES ${P4EST_ROOT}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}p6est${CMAKE_SHARED_LIBRARY_SUFFIX})
  list(APPEND P4EST_LIBRARIES ${P4EST_ROOT}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}p8est${CMAKE_SHARED_LIBRARY_SUFFIX})
else()
  set(P4EST_LIBRARIES ${P4EST_ROOT}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}p4est${CMAKE_STATIC_LIBRARY_SUFFIX})
  list(APPEND P4EST_LIBRARIES ${P4EST_ROOT}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}p6est${CMAKE_STATIC_LIBRARY_SUFFIX})
  list(APPEND P4EST_LIBRARIES ${P4EST_ROOT}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}p8est${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
